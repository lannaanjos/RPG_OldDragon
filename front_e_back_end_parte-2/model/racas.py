...
class Raca:
    def __init__(self, nome: str, mod_atributos: dict):
        self.nome = nome
        self.mod_atributos = {h: int(mod_atributos.get(h, 0)) for h in HABILIDADES} # pega o valor de atributos ou 0 se n existir
...
LISTA_RACAS = [r.nome for r in [HUMANO, ELFO, ANAO]] # usado no select
